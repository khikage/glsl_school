...
class WebGLApp {
  ...
  setup() {
    this.setupGeometry();
    this.resize();
    this.gl.clearColor(0.15, 0.14, 0.15, 1.0);
  ...
  setupGeometry() {
    ...
    // 頂点カラーの定義
    this.color = [
      0.91, 0.61, 0.66, 1.0, // ピンク
      0.78, 0.17, 0.11, 1.0, // 赤
      0.94, 0.73, 0.29, 1.0, // 黄
      0.18, 0.31, 0.56, 1.0, // 青
      0.94, 0.95, 0.95, 1.0, // 白
      0.45, 0.32, 0.16, 1.0, // 茶
      0.22, 0.46, 0.27, 1.0, // 緑
